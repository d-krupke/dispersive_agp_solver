...
def solve(instance: Instance, time_limit: float=900.0, opt_tol: float=0.0001, logger: typing.Optional[logging.Logger]=None, **params) -> typing.Tuple[typing.List[int], float, float]:
