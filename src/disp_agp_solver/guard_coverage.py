import typing
from pyvispoly import VisibilityPolygonCalculator, PolygonWithHoles, Polygon, Point
...
class GuardCoverage:
    ...
    def __init__(self, instance: Instance) -> None:
        ...
        self._visibility_polygon_calculator = VisibilityPolygonCalculator(instance.as_cgal_polygon())
        self._vis_polys = self._compute_visibilities()

    def _compute_visibilities(self) -> typing.List[Polygon]:
        return [
            PolygonWithHoles(self._visibility_polygon_calculator.compute_visibility_polygon(
    ...
    def can_guards_see_each_other(self, guard_a: int, guard_b: int) -> bool:
        return self.get_visibility_of_guard(guard_a).contains(self._instance.as_cgal_position(guard_b))

    def get_visibility_of_guard(self, guard: int):
        return self._vis_polys[guard]
    
    def compute_uncovered_area(self, guards: typing.List[int]) -> typing.List[PolygonWithHoles]:
    ...
    def compute_guards_for_witness(self, witness: Point) -> typing.List[int]:
        ...
        Compute which vertex guard can see the given witness.
        """
        vis_poly = self._visibility_polygon_calculator.compute_visibility_polygon(witness)
